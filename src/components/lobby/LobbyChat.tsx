...
export const LobbyChat = ({ messages, onSendMessage, currentUserId, canChat }: LobbyChatProps) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow h-[600px] flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200">
        <h3 className="text-lg font-semibold">Chat du lobby</h3>
        {!canChat && (
      ...
      <div className="p-4 border-t border-gray-200">
        <form onSubmit={handleSubmit} className="flex space-x-2">
          ...
          <button
            ...
            className="bg-blue-500 hover:bg-blue-700 disabled:bg-gray-300 text-white px-4 py-2 rounded-lg transition-colors"
          >
            Envoyer
          </button>
        </form>
